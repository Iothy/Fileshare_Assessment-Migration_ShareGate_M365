...
.PARAMETER MinSizeMB
    ...
    Valeur par défaut : 50 MB (sweet spot ROI/perf identifié sur le périmètre DSI Carambar).
...
.EXAMPLE
    ...
    .\Get-DuplicateFiles.ps1 -MappingCsv ".\Config\FileShareMapping.Carambar.csv"
